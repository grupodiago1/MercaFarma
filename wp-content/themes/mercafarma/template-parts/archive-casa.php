...
<section class="blog-page-section">
    <div class="container">
      ...
      <div data-id="1a18b35" class="elementor-element elementor-element-1a18b35 elementor-widget elementor-widget-Kinetic-Global-Widgets-Blog-Col" data-element_type="Kinetic-Global-Widgets-Blog-Col.default">
                    ...
                    ?>
                      ...
                      <div class="col-md-4">
                        ...
                        <h2 class="heading2"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
                          <ul class="post-tags">
                            <?php $categoria = wp_get_post_terms(get_the_ID(), 'categoria', array("fields" => "all"));?>
