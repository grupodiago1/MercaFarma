...
class Kinetic_Elementor_Global_Widgets_Gallery_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'Kinetic-Global-Widgets-Gallery-Carousel';
	}
	...
	public function get_title() {
		return esc_html__( 'Gallery Carousel', 'kinetic' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Gallery Carousel', 'kinetic' ),
			)
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'title' => esc_html__( 'Gallery #1', 'kinetic' ),
						
					],
					[
						'title' => esc_html__( 'Gallery #2', 'kinetic' ),
